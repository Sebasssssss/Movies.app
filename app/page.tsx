...
export default function Home() {
  ...
  return (
    <>
      <main className="h-[100vh] grid items-center w-full bg-[url('../public/homepage.jpg')] bg-cover bg-center p-5">
        <div className=" max-w-[1200px] mx-auto grid items-center w-full h-[100vh]">
          <div className="text-justify grid gap-5 w-96">
            ...
            <p className={`${inter.className} text-sm`}>
              ...
              boss Tommy Shelby. Thomas Shelby and his brothers return to
              Birmingham after serving in the British Army during WWI.
            </p>
